...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'phone'=>[
            'required' => 'Оставьте телефон для доп. связи с вами',
        ],
        'competencies'=>[
            'required' => 'Укажите, что вы хотите выполнять в проекте',
        ],
        'skill'=>[
            'required' => 'Укажите ваши положительные качества, чем занимались ранее',
        ],
        'course'=>[
            'required' => 'Укажите ваш курс',
        ],
        'training_group'=>[
            'required' => 'Укажите вашу учебную группу',
        ],
        'experience'=>[
            'required' => 'Поделитесь, принимали ли ранее участие в проектах или в чем-то подобном, делая какую-то конкретную задачу',
        ],
        'personconfirm'=>[
            'required'=> 'Без согласия на обработку/хранения ваших персональных данных мы не можем принять вашу заявку',
        ],
        'title'=>[
            'required'=> 'Введите название проекта',
        ],
        'goal'=>[
            'required'=> 'Обозначьте цель проекта',
        ],
        'idea'=>[
            'required'=> 'Введите идею проекта',
        ],
        'requirements'=>[
            'required'=> 'Задайте требования к участникам',
        ],
        'expected_result'=>[
            'required'=> 'Введите ожидаемый результат',
        ],
        'customer'=>[
            'required'=> 'Введите заказчика',
        ],
        'type_id'=>[
            'required'=> 'Определите тип проекта',
        ],
        'date_start'=>[
            'required'=> 'Задайте дату начала проекта',
            'after_or_equal'=>'Дата не может быть прошлой'
        ],
        'date_end'=>[
            'required'=> 'Задайте дату окончания проекта',
            'after_or_equal'=>'Дата окончания должна быть больше или равна дате начала'
        ],
        'places'=>[
            'required'=> 'Укажите сколько человек будет в команде',
        ],
        'tags'=>[
        ...
        's_fio'=>[
            'required'=>'Поле имени руководителя обязательно к заполнению',
        ],
        's_email'=>[
